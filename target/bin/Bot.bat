...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="Bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" bot.VampusBot %CMD_LINE_ARGS%
